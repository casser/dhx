class XLayoutObject extends XCellTop {
    ...
    constructor(base, pattern, skin) {
        ...
        this._init = function (pattern) {
            var t = (typeof(pattern) == "string" ? XLayoutObject.tplData[pattern] : pattern );
        ...
        var a = XLayoutObject._availAutoSize[pattern];
        if (a != null) {
    ...
    listPatterns() {
        var t = [];
        for (var a in XLayoutObject.tplData) {
            t.push(a);
        }
        return t;
    }
    listAutoSizes() {
        ...
        var allH = XLayoutObject._availAutoSize[this.conf.pattern].h;
        var allV = XLayoutObject._availAutoSize[this.conf.pattern].v;
    ...
    _detectSW() {
        if (XLayoutObject._confGlob.sw == null) {
    ...
    constructor(mode, idx) {
        ...
        this._initResizeArea = function () {
            ...
            if (this.r_area == null) {
                ...
                if (!XLayoutObject._confGlob.reszieCover) {
                    XLayoutObject._confGlob.reszieCover = {};
                    this.r_area.style.width = w + "px";
                    this.r_area.style.height = h + "px";
                    XLayoutObject._confGlob.reszieCover.w = parseInt(this.r_area.style.width) - this.r_area.offsetWidth;
                    XLayoutObject._confGlob.reszieCover.h = parseInt(this.r_area.style.height) - this.r_area.offsetHeight;
                }
                this.r_area.style.width = w + XLayoutObject._confGlob.reszieCover.w + "px";
                this.r_area.style.height = h + XLayoutObject._confGlob.reszieCover.h + "px";
            }
...
class dhtmlXLayoutCell extends XCellObject {
    constructor(id, layout) {
        ...
        if (this.conf.mode != "c") {
            ...
            t.innerHTML = '<i class="material-icons">&#xE314;</i>';
    ...
    _fitHdr() {
        ...
        if (this.conf.collapsed == true) {
            if (typeof(XLayoutObject._confGlob.hdrColH) == "undefined") {
                h.style.height = this.cell.offsetHeight + "px";
                XLayoutObject._confGlob.hdrColH = parseInt(h.style.height) - this._getHdrHeight(true);
            }
            var size = this.cell.offsetHeight + XLayoutObject._confGlob.hdrColH;
...
XCellObject.prototype.attachLayout = function (conf) {
    ...
    this.dataObj = new XLayoutObject(conf);
