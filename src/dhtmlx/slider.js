class dhtmlXSlider {
    constructor(data) {
        ...
        this._nodes.cont.onmousedown = this._nodes.track.onmousedown = this._nodes.cont.onselectstart = this._nodes.track.onselectstart = function (e) {
            e = e || event;
        ...
        this._initMover = function (e, index) {
			...
			if (index != null) {
				...
				if (that._r_actv.className.indexOf("dhxsl_runner") == -1) {
					that._r_actv = that._nodes.runner;
				}
			}
        ...
        this._doOnSetValue = function (e) {
			...
			if (that._movingInitialValues != null) {
				return false;
			}
            e = e || event;
			if (typeof(e.preventDefault) == "function") {
			...
			if (t.className.match(/dhxsl_track_bg/) != null) {
				ofs = parseInt(t.style[that.conf.vertical ? "top" : "left"]);
			}
