class dhtmlXCalendarObject {
    ...
    get lang(){
        return dhtmlXCalendarObject.config.lang
    }
    set lang(v){
        dhtmlXCalendarObject.config.lang=v;
    }
    get langData(){
        return dhtmlXCalendarObject.config.langData
    }

    constructor(inps, skin) {
        this.i = {};
        var p = null;
        ...
        li.innerHTML = "<div class='dhtmlxcalendar_month_arrow dhtmlxcalendar_month_arrow_left' onmouseover='this.className=\"dhtmlxcalendar_month_arrow dhtmlxcalendar_month_arrow_left_hover\";' onmouseout='this.className=\"dhtmlxcalendar_month_arrow dhtmlxcalendar_month_arrow_left\";'></div>" + "<span></span>" + // hdrformat will here
        ...
        li.onclick = function (e) {
            e = e || event;
            if (e.type == "touchstart" && e.preventDefault != null) {
                e.preventDefault();
            }
        ...
        li.innerHTML = "<div class='dhtmlxcalendar_time_img'></div>" + "<span class='dhtmlxcalendar_label_hours'></span><span class='dhtmlxcalendar_label_colon'>:</span><span class='dhtmlxcalendar_label_minutes'></span>" + "<span class='dhtmlxcalendar_label_clear'>" + this.langData[this.lang].clear + "</span><span class='dhtmlxcalendar_label_today'>" + this.langData[this.lang].today + "</span>"; // added in 4.6
        ul.appendChild(li);
        li.onclick = function (e) {
            e = e || event;
            if (e.type == "touchstart" && e.preventDefault != null) {
        ...
        this._show = function (inpId, autoHide) {
            ...
            if (!inpId) {
                ...
                if (this.pos == "right") {
                    ...
                    var x = inp.left;
                    if (x + this.base.offsetWidth > dim.right) {
                        x = Math.max(0, inp.left + i.offsetWidth - this.base.offsetWidth);
                    }
                    //
                    this.base.style.left = x + "px";
        ...
        if (typeof(window.addEventListener) == "function") {
            ...
            if (this.conf.touch == true) {
                document.body.addEventListener("touchstart", that._doOnClick, false);
            }
        } else {
        ...
        this.attachObj = function (obj) {
            ...
            if (typeof(obj) == "string") {
                ...
                this.i[a] = {};
                if (obj.input != null) {
                    this.i[a].input = (typeof(obj.input) == "string" ? document.getElementById(obj.input) : obj.input);
                }
                if (obj.button != null) {
                    this.i[a].button = (typeof(obj.button) == "string" ? document.getElementById(obj.button) : obj.button);
                }
            }
        ...
        this.detachObj = function (obj) {
            ...
            if (this.i[obj] != null) {
                ...
                if (a == null && obj.input != null) {
                    a = (typeof(obj.input) == "string" ? document.getElementById(obj.input) : obj.input)._dhtmlxcalendar_uid;
                }
                if (a == null && obj.button != null) {
                    a = (typeof(obj.button) == "string" ? document.getElementById(obj.button) : obj.button)._dhtmlxcalendar_uid;
                }
            }
        ...
        this._attachEventsToObject = function (a) {
            if (this.i[a].button != null) {
                ...
                if (typeof(window.addEventListener) == "function") {
                    ...
                    if (this.conf.touch == true) {
                        this.i[a].button.addEventListener("touchstart", that._doOnBtnClick, false);
                    }
                } else {
                ...
                if (typeof(window.addEventListener) == "function") {
                    ...
                    if (this.conf.touch == true) {
                        this.i[a].input.addEventListener("touchstart", that._doOnInpClick, false);
                    }
                } else {
        ...
        this._detachEventsFromObject = function (a) {
            if (this.i[a].button != null) {
                if (typeof(window.addEventListener) == "function") {
                    ...
                    if (this.conf.touch == true) {
                        this.i[a].button.removeEventListener("touchstart", that._doOnBtnClick, false);
                    }
                } else {
                ...
                if (typeof(window.addEventListener) == "function") {
                    ...
                    if (this.conf.touch == true) {
                        this.i[a].input.removeEventListener("touchstart", that._doOnInpClick, false);
                    }
                } else {
        ...
        this.unload = function () {
            ...
            if (typeof(window.addEventListener) == "function") {
                ...
                if (this.conf.touch == true) {
                    document.body.removeEventListener("touchstart", that._doOnClick, false);
                }
            } else {
...
function dhtmlXDoubleCalendar(parentId) {
    var that = this;
    ...
    this.setDates = function (d0, d1) {
        if (d0 != null) {
            this.leftCalendar.setDate(d0);
        }
        if (d1 != null) {
            this.rightCalendar.setDate(d1);
        }
        this._updateRange();
    }
