class dhtmlXCarousel extends XCellTop {
    static get config(){
    ...
    _initControls() {
        ...
        this._doOnControlClick = function (e) {
            ...
            if (t.className != null) {
                ...
                if (t.className.match(/dhx_carousel_onebar/) != null && t.className.match(/dhx_carousel_baractv/) == null) {
...
class dhtmlXCarouselCell extends XCellObject {
...
XCellObject.prototype.attachCarousel = function (conf) {
