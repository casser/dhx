...
function decorate(clazz){
	Object.getOwnPropertyNames(clazz.prototype).forEach(function (k) {
		var desc = Object.getOwnPropertyDescriptor(clazz.prototype,k);
		desc.enumerable = true;
		Object.defineProperty(clazz.prototype,k,desc)
	})
}

class dhtmlXFileUploaderHtml5 {
	constructor(){
		return decorate(this.constructor);
	}
...
class dhtmlXFileUploader{

	constructor(p, swfPath, swfUrl, mode, swfLogs, slXap, slUrl, slLogs, multiple) {
	...
	get html5(){
		return dhtmlXFileUploaderHtml5;
	}
	get html4(){
		return dhtmlXFileUploaderHtml4;
	}
	get flash(){
		return dhtmlXFileUploaderFlash;
	}
	get sl(){
		return dhtmlXFileUploaderSl;
	}
	setSLURL(url) {
