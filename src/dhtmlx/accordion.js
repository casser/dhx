class dhtmlXAccordion extends XCellTop {
...
class dhtmlXAccordionCell extends XCellObject {
    constructor(id, acc) {
        super(id, "_acc")
        this.acc = acc;
    ...
    _initHeader() {
        ...
        t.innerHTML = "<div class='dhx_cell_hdr_text'></div>" + "<div class='dhx_cell_hdr_arrow'><i class='material-icons'>keyboard_arrow_down</i></div>";
...
XCellObject.prototype.attachAccordion = function (conf) {
