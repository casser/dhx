...
dhtmlXGridObject.prototype = {
    ...
    _hideShowColumn: function (ind, state) {
        ...
        if (state == "none") {
            ...
            if ((dhx4.isOpera && _OperaRv < 9) || dhx4.isKHTML || (dhx4.isFF)) {
            ...
            if (this.hdr.rows[0].cells[ind]._oldWidth) {
                ...
                if (dhx4.isOpera || dhx4.isKHTML || dhx4.isFF) {
    ...
    render_dataset: function (min, max) {
        ...
        if (this._srnd && !this._fillers) {
            ...
            while (add_count > 0) {
                var add_step = (dhx4.isIE || dhx4.isFF) ? Math.min(add_count, block_size) : add_count;
