class dhtmlXLayoutObject extends dhtmlXCellTop {
    static get _confGlob() {
        return Object.defineProperty(this, '_confGlob', {
            value: {}
        })._confGlob
    }

    static get tplData() {
        return Object.defineProperty(this, 'tplData', {
            value: {
    ...
    static get _availAutoSize() {
        return Object.defineProperty(this, '_availAutoSize', {
            value: {
                "1C": {
                    h: ["a"],
                    v: ["a"]
    ...
    constructor(base, pattern, skin) {
        ...
        if (base != null && typeof(base) == "object" && typeof(base.tagName) == "undefined" && base._isCell != true) {
            // api-init
            autoload = {};
            if (base.autosize != null) {
                autoload.autosize = base.autosize;
            }
            if (base.cells != null) {
                autoload.cells = base.cells;
            }
            ...
            if (base.offsets != null) {
                autoload.offsets = base.offsets;
            }
            base = base.parent;
        }
        this.cdata = {};
        ...
        if (typeof(base) == "object" && base._isCell == true) {
            ...
            if (conf.pattern == null && pattern != null) {
                conf.pattern = pattern;
            }
            if (conf.skin == null && skin != null) {
                conf.skin = skin;
            }
        ...
        // init top container
        dhtmlXCellTop.apply(this, [base, (autoload == null ? null : autoload.offsets)]);
        ...
        this._init = function (pattern) {
            var t = (typeof(pattern) == "string" ? dhtmlXLayoutObject.tplData[pattern] : pattern );
            ...
            if (this.conf.mode != "c") {
                ...
                if (mainInst.conf.sep_idx == null) {
                    mainInst.conf.sep_idx = 1;
                } else {
                    mainInst.conf.sep_idx++;
                }
            ...
            if (t.cells != null) {
                for (var a in t.cells) {
                    if (t.cells[a].width != null) {
                        this.cdata[a].conf.init.w = t.cells[a].width;
                    }
                    if (t.cells[a].height != null) {
                        this.cdata[a].conf.init.h = t.cells[a].height;
                    }
                    ...
                    // fixed size conf
                    if (t.cells[a].fsize != null) {
                        this.cdata[a].conf.fsize = t.cells[a].fsize;
                    }
                }
            }
            this.setSizes();
        ...
        var a = dhtmlXLayoutObject._availAutoSize[pattern];
        if (a != null) {
        ...
        if (this == this._getMainInst() && autoload != null) {
            if (autoload.autosize != null) {
                this.setAutoSize.apply(this, autoload.autosize);
            }
            if (autoload.cells != null) {
                for (var q = 0; q < autoload.cells.length; q++) {
                    ...
                    if (data.collapsed_text) {
                        cell.setCollapsedText(data.collapsed_text);
                    }
                    if (data.collapse) {
                        cell.collapse();
                    }
    ...
    cells(name) {
        for (var a in this.cdata) {
            if (this.cdata[a].conf.name == name) {
                return this.cdata[a];
            }
    ...
    forEachItem(handler, env) {
        ...
        for (var a in this.cdata) {
            if (typeof(this.cdata[a].conf.name) != "undefined") {
                handler.apply(env, [this.cdata[a]]);
            }
            if (this.cdata[a].dataType == "layout" && this.cdata[a].dataNested == true && this.cdata[a].dataObj != null) {
    ...
    listPatterns() {
        var t = [];
        for (var a in dhtmlXLayoutObject.tplData) {
            t.push(a);
        }
        return t;
    }
    ...
    listAutoSizes() {
        ...
        var allH = dhtmlXLayoutObject._availAutoSize[this.conf.pattern].h;
        var allV = dhtmlXLayoutObject._availAutoSize[this.conf.pattern].v;
        return [curH, curV, allH, allV];
    }

    setAutoSize(hor, ver, innerCall) {
        if (innerCall !== true) {
        ...
        for (var a in this.cdata) {
            ...
            var s = false;
            for (var q = 0; q < this.conf.as_cells[m].length; q++) {
                s = s || k[this.conf.as_cells[m][q]];
            }
            if (s) {
                this.conf.autosize = a;
            }
            if (this.cdata[a].dataType == "layout" && this.cdata[a].dataObj != null) {
                this.cdata[a].dataObj.setAutoSize(hor, ver, true);
            }
        }
    }

    setSeparatorSize(index, size) {
    ...
    _detectSW() {
        if (dhtmlXLayoutObject._confGlob.sw == null) {
            dhtmlXLayoutObject._confGlob.sw = {};
        }
        if (dhtmlXLayoutObject._confGlob.sw[this.conf.skin] == null) {
            dhtmlXLayoutObject._confGlob.sw[this.conf.skin] = window.dhx4.readFromCss("dhxlayout_sep_sw_" + this.conf.skin);
        }
        return dhtmlXLayoutObject._confGlob.sw[this.conf.skin];
    }

    _getCellsNames(cId) {
        var names = {};
        if (this.cdata[cId].conf.name != null) {
            names[this.cdata[cId].conf.name] = true;
        }
...
class dhtmlXLayoutSepObject {
    constructor(mode, idx) {
        var that = this;
        this.conf = {
            mode: mode,
            idx: idx,
        ...
        this._beforeResize = function (e) {
            ...
            if (e.type == window.dhx4.dnd.evs.start) {
                ...
                if (e.button !== this.conf.btn_left) {
                    return;
                }
                var sx = e.clientX;
                var sy = e.clientY;
        ...
        this._afterResize = function (e) {
            ...
            if (rCells !== false) {
                ...
                mainInst.forEachItem(function (cell) {
                    ...
                    if (!(t.w == cell.conf.size.w && t.h == cell.conf.size.h)) {
                        p.push(cell.conf.name);
                    }
                    cell = null;
                });
        ...
        this._initResizeArea = function () {
            ...
            if (this.r_area == null) {
                ...
                if (!dhtmlXLayoutObject._confGlob.reszieCover) {
                    dhtmlXLayoutObject._confGlob.reszieCover = {};
                    this.r_area.style.width = w + "px";
                    this.r_area.style.height = h + "px";
                    dhtmlXLayoutObject._confGlob.reszieCover.w = parseInt(this.r_area.style.width) - this.r_area.offsetWidth;
                    dhtmlXLayoutObject._confGlob.reszieCover.h = parseInt(this.r_area.style.height) - this.r_area.offsetHeight;
                }
                this.r_area.style.width = w + dhtmlXLayoutObject._confGlob.reszieCover.w + "px";
                this.r_area.style.height = h + dhtmlXLayoutObject._confGlob.reszieCover.h + "px";
            }
        ...
        this._doOnMouseUp = function (e) {
            e = e || event;
            if (e.type == "mouseup" && e.button !== that.conf.btn_left) {
                return;
            }
            that._afterResize(e);
        };
...
class dhtmlXLayoutCell extends dhtmlXCellObject {
    ...
    _fitHdr() {
        ...
        if (this.conf.collapsed == true) {
            if (typeof(dhtmlXLayoutObject._confGlob.hdrColH) == "undefined") {
                h.style.height = this.cell.offsetHeight + "px";
                dhtmlXLayoutObject._confGlob.hdrColH = parseInt(h.style.height) - this._getHdrHeight(true);
            }
            var size = this.cell.offsetHeight + dhtmlXLayoutObject._confGlob.hdrColH;
    ...
    collapse() {
        ...
        var k = this.layout;
        if (k.cdata[k.conf.nextCell[this._idd]].expand(true) == false) {
            return false;
        } // no space to expand next cell if it collapsed
        if (this.conf.mode == "v") {
    ...
    setMinWidth(w) { // added in 4.1.3
        this.conf.min_width = parseInt(w) || 0;
    }
    setMinHeight(h) { // added in 4.1.3
        this.conf.min_height = parseInt(h) || 0;
    }
    _getMinWidth(parentIdd) {
        ...
        if (this.dataType == "layout" && this.dataObj != null) {
            ...
            if (this.dataObj.conf.pattern == "1C") {
                ...
                if (this.dataObj.cdata[c1].conf.collapsed) {
                    c1 = this.dataObj.conf.nextCell[c1];
                }
    ...
    _getMinHeight(parentIdd) {
        var h = 0;
        if (this.conf.idx.menu != null) {
            h += this.cell.childNodes[this.conf.idx.menu].offsetHeight;
        }
        if (this.dataType == "layout" && this.dataObj != null) {
            if (this.layout._getMainInst() != this.dataObj._getMainInst()) {
    ...
    _getAvailHeight(parentIdd) {
        ...
        if (this.conf.mode == "v" && this.conf.collapsed) {
            hh = this.conf.hh;
        } // not include header if v-cell is collapsed
    ...
    setWidth(w) {
        if (this.conf.mode == "v") {
            ...
            for (var a in p.cdata) {
                if (p.cdata[a].dataObj == k) {
                    p.cdata[a].setWidth(w);
                }
            }
            p = k = null;
        }
            ...
            if (cell.conf.fsize != null) {
                ...
                for (var a in p) {
                    if (p[a] == true && cell.conf.fsize[a] != null) {
                        if (!(cell.conf.fsize[a] instanceof Array)) {
                            cell.conf.fsize[a] = [cell.conf.fsize[a]];
                        }
                        for (var q = 0; q < cell.conf.fsize[a].length; q++) {
                            s[cell.conf.fsize[a][q]] = true;
                        }
                    }
                }
            }
...
dhtmlXCellObject.prototype.attachLayout = function (conf) {
    ...
    if (typeof(dhtmlXLayoutCell) == "function" && this instanceof dhtmlXLayoutCell) {
    ...
    if (typeof(dhtmlXSideBarCell) == "function" && this instanceof dhtmlXSideBarCell) {
        if (this.conf.skin == "dhx_web") {
            ...
            if (this.sidebar.conf.header == true) {
                obj._ofs.t = 9;
            } // default separator size for web
