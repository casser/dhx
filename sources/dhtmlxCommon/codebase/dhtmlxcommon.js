...
window.dhx4.isKHTML = (navigator.userAgent.indexOf("Safari") >= 0 ) && !window.dhx4.isEdge && !window.dhx4.isChrome;
window.dhx4.isFF = (navigator.userAgent.indexOf("Firefox") >= 0);
window.dhx4.isIPad = (navigator.userAgent.search(/iPad/gi) >= 0);
window.dhx4.isWebKit = navigator.userAgent.indexOf("KHTML") >= 0;
window.dhx4.isMacOS = navigator.userAgent.indexOf('Macintosh') >= 0;
// dnd data
window.dhx4.dnd = {
    evs: {},
...
function dhtmlxXValidation() {
}
dhtmlxXValidation.prototype = {
...
var dhtmlxValidation = new dhtmlxXValidation();
window.dhtmlx = {
    extend: function (a, b) {
        for (var key in b)
            if (!a[key])
