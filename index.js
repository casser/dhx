class App {
    constructor() {
        this.main = new dhtmlXLayoutObject({
    ...
    showFileContent(id) {
        var w1;
        if (!this.wins.window("popup")) {
            w1 = this.wins.createWindow("popup", 10000, 10000, 800, 600);
            w1.setText("Preview");
            //w1.denyResize();
            w1.button("park").hide();
            ...
            w1 = this.wins.window("popup");
        }
        w1.setModal(true);
        w1.attachURL("./kitchen/data/files.xml");
    }
